...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/steep-wave-f22e)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/steep-wave-f22e
```

A live public deployment of this template is available at [https://steep-wave-f22e.templates.workers.dev](https://steep-wave-f22e.templates.workers.dev)
